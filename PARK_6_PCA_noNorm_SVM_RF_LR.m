%% Classification PD and HC based on individual natural frequency maps for Parkinson's study (Arana et al., 2026)-PCA and no Normalization
% This script is employed for internal cross validation of the model under
% the PCA with NO normalization scheme.
...
for c = 1:length(pca_components_list)
    ...
    fprintf('Evaluating PCA with %d componentes...\n', n_components);
    ...
    for rep = 1:n_reps
        ...
        for fold = 1:kfold
            ...
            X_train_pca = X_train * coeff_reduced;
            X_test_pca = X_test * coeff_reduced;
            ...
            % RF
            model_rf = TreeBagger(100, X_train_pca, categorical(Y_train), 'Method', 'classification');
